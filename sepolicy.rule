...
magiskpolicy --live "dontaudit { vendor_overlay_file theme_data_file app_data_file } labeledfs filesystem associate"
magiskpolicy --live "allow     { vendor_overlay_file theme_data_file app_data_file } labeledfs filesystem associate"
magiskpolicy --live "dontaudit init { vendor_overlay_file theme_data_file app_data_file } dir relabelfrom"
magiskpolicy --live "allow     init { vendor_overlay_file theme_data_file app_data_file } dir relabelfrom"
magiskpolicy --live "dontaudit init { vendor_overlay_file theme_data_file app_data_file } file relabelfrom"
magiskpolicy --live "allow     init { vendor_overlay_file theme_data_file app_data_file } file relabelfrom"
...
magiskpolicy --live "dontaudit { system_app priv_app platform_app untrusted_app_29 untrusted_app_27 untrusted_app } proc_pid_max file { read open }"
magiskpolicy --live "allow     { system_app priv_app platform_app untrusted_app_29 untrusted_app_27 untrusted_app } proc_pid_max file { read open }"
